while True:
    ...
    try:
        ...
        pw = easygui.passwordbox("Bitte gib das Passwort ein um Text-Nachrichten verschlüsseln zu können!", "Passwort")
        if pw == "12345":
            vn = ""
            ...
            wv = tk.Label(root, text="Welchen Text möchtest du verschlüsseln?:", bg="darkgreen")
            wv.grid(row=0, column=0)
            wt = tk.Entry(root, bg="grey")
            wt.grid(row=0, column=1)
            vb = tk.Button(root, text="verschlüsseln", command=verschlüsseln, bg="darkblue")
            vb.grid(row=0, column=2)
            wht = tk.Label(root, text="Verschlüsselter Text: ", bg="darkgreen")
